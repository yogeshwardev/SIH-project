    ...
    if search:
        ...
        query = query.filter(
            or_(
                ...
                Product.title_telugu.ilike(search_pattern),
                Product.description.ilike(search_pattern),
                Product.description_telugu.ilike(search_pattern),
...
def _format_product_response(p: Product, db: Session) -> ProductResponse:
    ...
    return ProductResponse(
        ...
        short_description_telugu=p.short_description_telugu,
        description=p.description,
        description_hindi=p.description_hindi,
        description_telugu=p.description_telugu,
